...
function M.get()
  if M._keys then
    ...
    -- stylua: ignore
    M._keys = {
      { "gh", function() require("pretty_hover").hover() end, desc = "Preview Hover" },
      ...
      { "<leader>a", vim.lsp.buf.code_action, desc = "[C]ode [A]ction" },

      { "<leader>lp", "<cmd>LspInfo<cr>", desc = "[L]sp Info" },
